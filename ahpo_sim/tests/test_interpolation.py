...
def test_lookup_nearest_matches_characteristic_map_lookup() -> None:
    ...
    cell = cm.update(5.0, 41.0, charge_pump_speed=30.0, spread_error=1.0)
...
def test_interpolate_optimal_speed_blends_all_four_corners() -> None:
    ...
    cm = CharacteristicMap(outdoor_temp_step=2.0, compressor_freq_step=2.0)
    cm.update(4.0, 40.0, charge_pump_speed=20.0, spread_error=1.0)
    cm.update(4.0, 42.0, charge_pump_speed=30.0, spread_error=1.0)
    cm.update(6.0, 40.0, charge_pump_speed=40.0, spread_error=1.0)
    cm.update(6.0, 42.0, charge_pump_speed=50.0, spread_error=1.0)
