...
def _entity_mapping_schema(defaults: dict[str, Any] | None = None) -> vol.Schema:
    ...
    fields = dict([
        ...
        _req(CONF_SECONDARY_FLOW_TEMP, _ENTITY_SELECTOR),
        _req(CONF_SECONDARY_RETURN_TEMP, _ENTITY_SELECTOR),
...
def _settings_schema(defaults: dict[str, Any] | None = None) -> vol.Schema:
    ...
    fields = dict([
        ...
        _num(OPT_MIN_SPEED_STEP_PERCENT, 0.0, 10.0, 0.1),
        _num(OPT_CONFIDENCE_THRESHOLD, 0.0, 1.0, 0.05),
        _num(OPT_CONFIDENCE_MIN_SAMPLES, 1.0, 100.0, 1.0),
        _num(OPT_CONFIDENCE_MAX_SPREAD_ERROR_STD, 0.1, 5.0, 0.1),
        ...
        _num(OPT_SPREAD_CONTROLLER_KP, 0.1, 20.0, 0.1),
        _num(OPT_SPREAD_CONTROLLER_DEADBAND_K, 0.0, 5.0, 0.05),
        _num(OPT_SPREAD_CONTROLLER_MAX_STEP_PERCENT, 1.0, 50.0, 1.0),
        (
